...
const ProductDetails = ({ product = {} }) => {
  ...
  const handleAddToCart = () => {
    showTemporaryNotification(`${quantity} ${product.name} added to your cart`);
  };

  const handleBuyNow = () => {
    showTemporaryNotification(`Finding best price for ${product.name}`);
  };
            ...
            {activeTab === "reviews" && (
              <div className="reviews-tab">
                ...
                <div className="reviews-list">
                  {finalProduct.reviews && finalProduct.reviews.length > 0 ? (
