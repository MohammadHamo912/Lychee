...
import FiltersPanel from "../components/FiltersPanel"; // ✅ Your component
...
const SearchPage = () => {
    ...
    const performSearch = (term) => {
        ...
        setResults(filtered);
        setFilteredResults(filtered); // default unfiltered list
        setLoading(false);
    };
    ...
    const applyFilters = (filters) => {
        ...
        if (filters.rating !== "all") {
            updated = updated.filter((item) => Math.floor(item.rating) >= parseInt(filters.rating));
        }
